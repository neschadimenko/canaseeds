...
<div class="col-main">
    ...
    <!--
            <a href="http://can.sysint.net/katalog.html?dir=desc&amp;norobot=1&amp;order=name&amp;packing=67_68" title="Сортируется по возрастанию. Установить по убыванию"><img src="http://can.sysint.net/skin/frontend/cann/v1/images/i_asc_arrow.gif" alt="Сортируется по возрастанию. Установить по убыванию" class="v-middle" /></a>
        -->
				</div>
                <ol class="products-list" id="products-list">
				<?$i = 1;?>
				<?foreach ($arResult['ITEMS'] as $key => $arItem){?>
					<?if (!($i++ % 2)):?><li class="item odd">
					<?else:?><li class="item even">
					<?endif;?>
					    <a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" title="<?echo $arItem['NAME'];?>" class="product-image">
							...
							<span class="block-count-sids-product-list">
							<span class="sid"></span>
								<?foreach ($arItem['OFFERS'] as $arOffer){?>
									<?echo $arOffer['PROPERTIES']['SHTUK_V_UPAKOVKE']['VALUE'];?>
								<?}?>
							</span><?
							endif;?>
						</a>
										...
										<tr>
											...
											<td class="b-price">
												<div class="Oprice" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
													...
													<div class="price-box" property="v:pricerange">
														<p class="old-price">
															<span itemprop="highPrice" class="price" id="old-price-3">
																786&nbsp;грн.
															</span>
														</p>
														<p class="special-price">
															<span itemprop="lowPrice" class="price" id="product-price-3">
																699&nbsp;грн.
															</span>
														</p>
														<span class="regular-price" id="product-price-14">
															<span itemprop="price" class="price"><?echo $arItem['MIN_PRICE']['PRINT_VALUE']?></span>
														</span>
													</div>
												</div>
												<p><button type="button" title="Купить" class="button btn-cart" onclick="setLocation('http://can.sysint.net/checkout/cart/add/uenc/aHR0cDovL2Nhbi5zeXNpbnQubmV0L2thdGFsb2cuaHRtbD9ub3JvYm90PTEmcGFja2luZz02N182OA,,/product/3/')"><span><span>Купить</span></span></button></p>
											</td>
										</tr>
										<tr>
											<td colspan="2" class="b-another">
												<div class="cataloglist-item-compare clic-cmp UI-CATALOGCOMPARE-ADD-3">
													<a class="catalogcompare-add link-compare" href="http://can.sysint.net/catalog/product_compare/add/product/3/uenc/aHR0cDovL2Nhbi5zeXNpbnQubmV0L2thdGFsb2cuaHRtbD9ub3JvYm90PTEmcGFja2luZz02N182OA,,/">К сравнению</a>
											   </div>
											</td>
										</tr>
									</tbody>
...
<?/*?>            <li class="item last even">
                        <a href="http://can.sysint.net/nastraivaemyj-tovar-1.html" title="Настраиваемый товар-1" class="product-image">
                <img src="%D0%9A%D0%B0%D1%82%D0%B0%D0%BB%D0%BE%D0%B3_files/505-1488-thickbox_1.jpg" alt="Настраиваемый товар-1" height="160" width="120">
                                            </a>
            <div class="product-shop">
                <div class="f-fix">
                    <table class="product-list-table">
                        <tbody>
                            <tr>
                                <td colspan="2" class="name">
                                                                        <h2 class="product-name"><a href="http://can.sysint.net/nastraivaemyj-tovar-1.html" title="Настраиваемый товар-1">Настраиваемый товар-1</a></h2>
                                </td>
                            </tr>
                            <tr>
                                <td class="attributes">
                                                                                                            <ul class="block-attributes-catalog-list">
                                                                                <li>
                                            <img alt="Производитель" title="Производитель - Genehtik Seeds" src="%D0%9A%D0%B0%D1%82%D0%B0%D0%BB%D0%BE%D0%B3_files/ico_r.png">
                                            <span>Genehtik Seeds</span>
                                        </li>
                                                                                <li>
                                            <img alt="Тип" title="Тип - Авто-феминизированные" src="%D0%9A%D0%B0%D1%82%D0%B0%D0%BB%D0%BE%D0%B3_files/ico_type.png">
                                            <span>Авто-феминизированные</span>
                                        </li>
                                                                                <li>
                                            <img alt="Вид" title="Вид - Автоцветущая индика" src="%D0%9A%D0%B0%D1%82%D0%B0%D0%BB%D0%BE%D0%B3_files/ico_aspect.png">
                                            <span>Автоцветущая индика</span>
                                        </li>
                                                                                <li>
                                            <img alt="Генетика" title="Генетика - Afghanistan, Critical Mass" src="%D0%9A%D0%B0%D1%82%D0%B0%D0%BB%D0%BE%D0%B3_files/ico_gen.png">
                                            <span>Afghanistan, Critical Mass</span>
                                        </li>
                                                                                <li>
                                            <img alt="Применение" title="Применение - Закрытый грунт, Теплица" src="%D0%9A%D0%B0%D1%82%D0%B0%D0%BB%D0%BE%D0%B3_files/ico_appl.png">
                                            <span>Закрытый грунт, Теплица</span>
                                        </li>
                                                                                <li>
                                            <img alt="Рост" title="Рост - высокий" src="%D0%9A%D0%B0%D1%82%D0%B0%D0%BB%D0%BE%D0%B3_files/ico_grow.png">
                                            <span>высокий</span>
                                        </li>
                                                                                <li>
                                            <img alt="ТГК" title="ТГК - 20,5%" src="%D0%9A%D0%B0%D1%82%D0%B0%D0%BB%D0%BE%D0%B3_files/ico_tgk.png">
                                            <span>20,5%</span>
                                        </li>
                                                                                <li>
                                            <img alt="Урожай" title="Урожай - 300 гр." src="%D0%9A%D0%B0%D1%82%D0%B0%D0%BB%D0%BE%D0%B3_files/ico_harv.png">
                                            <span>300 гр.</span>
                                        </li>
                                                                            </ul>
                                </td>
...
<div class="Oprice" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
    ...
    <div class="price-box" property="v:pricerange">
                                                            <span class="regular-price" id="product-price-14">
                                            <span itemprop="price" class="price">2&nbsp;621&nbsp;грн.</span>                                    </span>
                        
        </div>
</div>
                                                                            <p><button type="button" title="Купить" class="button btn-cart" onclick="setLocation('http://can.sysint.net/nastraivaemyj-tovar-1.html?options=cart')"><span><span>Купить</span></span></button></p>
                                                                    </td>
                            </tr>
                            <tr>
                                <td colspan="2" class="b-another">
                                    
                                    <div class="cataloglist-item-compare clic-cmp UI-CATALOGCOMPARE-ADD-14">
                                        <a class="catalogcompare-add link-compare" href="http://can.sysint.net/catalog/product_compare/add/product/14/uenc/aHR0cDovL2Nhbi5zeXNpbnQubmV0L2thdGFsb2cuaHRtbD9ub3JvYm90PTEmcGFja2luZz02N182OA,,/">К сравнению</a>
                                   </div>
                                                                    </td>
                            </tr>
                        </tbody>
...
<script>
    jQuery( ".btn-cart" ).click(function() {
        jQuery(this).effect("transfer", { to: jQuery(".header-cart") }, 1000);
    });
</script>
    </div>
</div>
